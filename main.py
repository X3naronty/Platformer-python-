...
def main(window):
    ...
    blocks = [*floor, Block(0, HEIGHT - 2 * block_size, block_size), Block(3 * block_size, HEIGHT - 4 * block_size, block_size), fire]
    offset_x = 0
    scroll_area = 200
    ...
    while run:
        ...
        if(player.rect.right - offset_x >= WIDTH - scroll_area and player.x_vel > 0) or (
